...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/opus_flutter_ios/opus_flutter_ios.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/opus_flutter_ios/opus.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/sherpa_onnx_ios/sherpa_onnx.framework"
fi
